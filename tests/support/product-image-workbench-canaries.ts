 ...
 * brought with them. A batch adds the archive that packs them all. Each of them
 * is named here so the boundary guard fails on any of them, not only on the
 * ones the last step produced.
 */
export const productImageWorkbenchCanaries: ToolContentCanary[] = [
  ...
  { label: '合規輸出檔名', value: 'compliant-product-image-01.jpg' },
  { label: '宣傳輸出檔名', value: 'brand-promo-image-01.png' },
  { label: '封存檔名', value: 'brand-promo-images.zip' },
